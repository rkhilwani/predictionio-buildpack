...
# For PredictionIO dist made for Scala 2.11 (chanlee514-pr-372)
./make-distribution.sh     -Dscala.version=2.11.8     -Dspark.version=2.1.1     -Dhadoop.version=2.7.3     -Delasticsearch.version=5.4.1
...
do
  mvn deploy:deploy-file -Durl=file://$(pwd)/repo/ -Dfile=/Users/mars.hall/.ivy2/local/org.apache.predictionio/apache-predictionio-${NAME}/0.11.1-SNAPSHOT/jars/apache-predictionio-${NAME}.jar -DpomFile=/Users/mars.hall/.ivy2/local/org.apache.predictionio/apache-predictionio-${NAME}/0.11.1-SNAPSHOT/poms/apache-predictionio-${NAME}.pom -DuniqueVersion=false
done
